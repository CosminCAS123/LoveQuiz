      ...
      <div className="main-block-wrapper p-8 mx-0 space-y-8 text-center">
        ...
        {!showIntro && report && (
          <>
            ...
            <div className="bg-white p-1 rounded-xl shadow-[0_30px_60px_-10px_rgba(233,184,195,0.8)]">
              <div className="bg-color-primary p-6 rounded-2xl shadow-lg max-w-md mx-auto space-y-4">
            ...
            <div className="bg-white p-1 rounded-xl shadow-[0_30px_60px_-10px_rgba(233,184,195,0.8)]">
              <div className="text-center space-y-3 bg-color-primary px-4 py-8 rounded-xl">
